  ...
  <section>
    <div class="calendar__grid calendar-form">
      <div class="form__create">
        ...
        <accreditation-form v-model="tournament" />
      ...
      <div class="calendar__help">
        <h5>Аккредитация турнира</h5>

        <p>
          Пройдите процедуру регистрации Заполнив можете скачать составленный договор для подписи.
        </p>
